...
const LeaveCalendar = () => {
  ...
  const isLeaveRequest = useMemo(() => {
    return location.pathname === "/leave" || location.pathname === "/leave/calendar";
  }, [location.pathname]);
    ...
    <>
      <div className="flex items-center justify-between mb-5">
        <div className="flex border-[1px] border-titan-400 rounded-lg">
          ...
          <span className='text-xs cursor-pointer hover:bg-titan-200 transition-all duration-500 font-normal hover:border-titan-200 px-2 border-r-2 py-1'>Users</span>
        </div>
