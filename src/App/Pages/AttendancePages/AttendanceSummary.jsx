...
import PieChartWithCenterLabel from '../../../Components/AttendanceSummaryChart'
...
const AttendanceSummary = () => {
  ...
  const isLeaveRequest = useMemo(() => {
    return location.pathname === "/attendance" || location.pathname === "/attendance/request";
  }, [location.pathname]);
        ...
        <div className="w-6/12 flex flex-col gap-y-5">
          <div className="border rounded-md p-4 flex justify-between">
            <div className="w-3/6 flex flex-col gap-1">
              <h1 className='text-2xl font-medium text-black'>12</h1>
              <p className='text-sm font-normal text-slate-500'>Total schedule hour</p>
            </div>
            <div className="w-3/6 flex flex-col gap-1">
              <h1 className='text-2xl font-medium text-black capitalize'>45 hr</h1>
              <p className='text-sm font-normal text-slate-500'>Leave hour</p>
            </div>
          </div>

          <div className="border rounded-md p-4 flex justify-between">
            <div className="w-3/6 flex flex-col gap-1">
              <h1 className='text-2xl font-medium text-black capitalize'>890 hrs</h1>
              <p className='text-sm font-normal text-slate-500'>Total work</p>
            </div>
            <div className="w-3/6 flex flex-col gap-1">
              <h1 className='text-2xl font-medium text-black capitalize'>312 days</h1>
              <p className='text-sm font-normal text-slate-500'>Total active</p>
            </div>
          </div>
        </div>
      </div>
