...
const settingSubRoute = [
  {
    path: "/setting/import/employee",
    subRoute: "Employee"
  },

  {
    path: "/setting/import/attendance",
    subRoute: "Attendance"
  }
]
    ...
    <div>
      <div className="flex gap-4 p-1">
        {settingSubRoute.map((link, index) => {
          ...
          const isActive =
            location.pathname === link.path || (location.pathname === "/setting/import" && link.path === "/setting/import/employee");
