...
const settingSubRoute = [
  {
    path: "/setting/attendance/preference",
    subRoute: "preference"
  },

  {
    path: "/setting/attendance/definition",
    subRoute: "definition"
  },

  {
    path: "/setting/attendance/ip",
    subRoute: "IP"
  },
]
    ...
    <div>
      <div className="flex gap-4 p-1">
        {settingSubRoute.map((link, index) => {
          ...
          const isActive =
            location.pathname === link.path || (location.pathname === "/setting/attendance" && link.path === "/setting/attendance/preference");
