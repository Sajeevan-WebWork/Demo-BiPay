...
const AssignLeaveModal = ({ closeModal }) => {
    return (
        <>
                            ...
                            <form className="space-y-4" action="#">
                                ...
                                <div className="flex gap-4">
                                    <div className="w-6/12">
                                        <div>
                                            <label htmlFor="leavetype" className="block mb-2 text-sm font-medium text-gray-900">Leave Type</label>

                                            <select id="leavetype" class="bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-titan-500 focus:outline-none focus:border-titan-500 block w-full p-2.5">
                                                <option selected>Choose Leave Type</option>
                                                <option value="full-day"> Emergency/Sick leave</option>
                                                <option value="half day"> Casual Leave</option>
                                                <option value="Perimission">Planned Leave</option>
                                                <option value="Perimission"> Floating Day Leave</option>
                                                <option value="Perimission"> Comp-Off Leave</option>
                                                <option value="Perimission"> Work From Home</option>
                                                <option value="Perimission">Perimission</option>
                                ...
                                <div className="flex gap-4">
                                    <div className="w-6/12">
                                        <div>
                                            <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900">Duration</label>
                                            <select id="countries" class="bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-titan-500 focus:outline-none focus:border-titan-500 block w-full p-2.5">
                                    ...
                                    <div className="w-6/12">
                                        <div>
                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Attachments</label>
                                            <input type="text" name="email" id="email" className="bg-gray-50 border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-titan-500 focus:outline-none focus:border-titan-500 block w-full p-2.5" placeholder="Choose date" required />
                                        </div>
                                    </div>
                                </div>

                                <div className="w-full">
                                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border-2 focus:outline-none border-gray-300 focus:ring-titan-500 focus:border-titan-500 " placeholder="Write your thoughts here..."></textarea>
                                </div>
